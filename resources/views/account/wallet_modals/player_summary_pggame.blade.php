...
<div class="modal fade" id="playerSummaryModal-PGGAME" tabindex="-1" role="dialog" aria-labelledby="playerSummaryModal-PGGAME" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 1000px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle-PGGAME">รายละเอียดการเล่น</h5>
